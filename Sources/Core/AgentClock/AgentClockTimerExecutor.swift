...
struct AppleScriptAgentClockRunner: AgentClockScriptRunning {
    func execute(_ spec: AgentClockTimerSpec) async -> AgentClockExecutionResult {
        ...
        let lines = [
            ...
            "set beforeCount to my safeAlarmCount(window 1)",
            ...
            "key code 36",
            "delay 0.35",
            "set afterCount to my safeAlarmCount(window 1)",
            ...
            "end run",
            "",
            "on safeAlarmCount(winRef)",
            "set c to 0",
            "try",
            "set c to count of rows of first table of first scroll area of winRef",
            "if c > 0 then return c",
            "end try",
            "try",
            "set c to count of groups of first scroll area of winRef",
            "if c > 0 then return c",
            "end try",
            "try",
            "set c to count of groups of first UI element of first scroll area of first group of winRef",
            "if c > 0 then return c",
            "end try",
            "return c",
            "end safeAlarmCount"
